using ProyectoMatzz.Logica;
using ProyectoMatzz.Models;
using ProyectoMatzz.Recursos;
using System;
...
namespace ProyectoMatzz.Controllers
{
    public class LoginController : Controller
    {
        ...
        public ActionResult Registrarse(string NNombres, string NApellidos, string NCorreo, string NContrasena, string NConfirmarContrasena)
        {
            ...
            Usuario oUsuario = new Usuario()
            {
                ...
                Correo = NCorreo,
                Contrasena = Utilidades.EncriptarClave(NContrasena),
                ConfirmarContrasena = Utilidades.EncriptarClave(NConfirmarContrasena),
